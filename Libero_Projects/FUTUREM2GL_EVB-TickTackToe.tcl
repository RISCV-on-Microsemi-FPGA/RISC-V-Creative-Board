set project_folder_name_axi MiV_AXI_IG2_Creative_TicTacToe
set project_dir_axi "./$project_folder_name_axi"
set Libero_project_name_axi MiV_AXI_BaseDesign

set project_folder_name_ahb MiV_AHB_IG2_Creative_TicTacToe
...
proc create_new_project_label_axi { }\
{
	...
	puts "--------MiV_RV32IMA_L1_AXI_BaseDesign_IG2_CREATIVE_TicTacToe-------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
proc create_new_project_label_ahb { }\
{
    ...
    puts "-------------------------------------------------------------------------"
    puts "-----------------------CREATING NEW PROJECT------------------------------"
	puts "--------MiV_RV32IMA_L1_AHB_BaseDesign_IG2_CREATIVE_TicTacToe-------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
if {"$target" == "AHB"} then {
	if {[file exists $project_dir_ahb] == 1} then {
		...
		source ./import/components/TickTackToe/AHB/import_component_and_constraints_ig2_creative_tictactoe_ahb.tcl
		save_project
		puts "-------------------------------------------------------------------------"
		puts "-------------------------------SUCCESS!----------------------------------"
		puts "-------------------------------------------------------------------------"
	...
	if {[file exists $project_dir_axi] == 1} then {
		...
		source ./import/components/TickTackToe/AXI/import_component_and_constraints_ig2_creative_tictactoe_axi.tcl
		save_project
		puts "-------------------------------------------------------------------------"
		puts "-------------------------------SUCCESS!----------------------------------"
		puts "-------------------------------------------------------------------------"
...
# ##
	...
	if {"$target" == "AHB"} then {
		export_prog_job \
			-job_file_name {BaseDesign_IG2_Creative_TicTacToe_AHB_ProgramFile} \
		...
		export_prog_job \
			-job_file_name {BaseDesign_IG2_Creative_TicTacToe_AXI_ProgramFile} \
			-export_dir {./../FlashPro_Express_Projects/Programming_Files} \
			-bitstream_file_type {TRUSTED_FACILITY} \
			-bitstream_file_components {}
		save_project
