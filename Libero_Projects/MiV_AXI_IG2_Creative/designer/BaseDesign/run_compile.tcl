...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\GitHub-LSRAM-12.3\RISC-V-Creative-Board-1\Libero_Projects\MiV_AXI_IG2_Creative\synthesis\BaseDesign.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\GitHub-LSRAM-12.3\RISC-V-Creative-Board-1\Libero_Projects\MiV_AXI_IG2_Creative\designer\BaseDesign} \
    -design BaseDesign \
    -fam IGLOO2 \
    -die PA4MGL2500_N \
    -pkg vf256 \
