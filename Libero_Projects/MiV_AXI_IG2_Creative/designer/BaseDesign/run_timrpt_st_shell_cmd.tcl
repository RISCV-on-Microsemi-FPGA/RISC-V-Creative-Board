read_sdc -scenario "timing_analysis" -netlist "optimized" -pin_separator "/" -ignore_errors {C:/GitHub-LSRAM-12.3/RISC-V-Creative-Board-1/Libero_Projects/MiV_AXI_IG2_Creative/designer/BaseDesign/timing_analysis.sdc}
...
set coverage [report \
    ...
    -format   xml \
    -slacks   no \
    {C:\GitHub-LSRAM-12.3\RISC-V-Creative-Board-1\Libero_Projects\MiV_AXI_IG2_Creative\designer\BaseDesign\BaseDesign_timing_constraints_coverage.xml} ]
report \
    -type     combinational_loops \
    -format   xml \
    {C:\GitHub-LSRAM-12.3\RISC-V-Creative-Board-1\Libero_Projects\MiV_AXI_IG2_Creative\designer\BaseDesign\BaseDesign_timing_combinational_loops.xml}
set_options -max_opcond best
set_options -min_opcond worst
set has_violations {C:\GitHub-LSRAM-12.3\RISC-V-Creative-Board-1\Libero_Projects\MiV_AXI_IG2_Creative\designer\BaseDesign\BaseDesign_has_violations}
...
set max_timing_violations_multi_corner [report \
    ...
    -format   xml \
    -multi_corner yes \
    {C:\GitHub-LSRAM-12.3\RISC-V-Creative-Board-1\Libero_Projects\MiV_AXI_IG2_Creative\designer\BaseDesign\BaseDesign_max_timing_violations_multi_corner.xml} ]
...
set max_timing_multi_corner [report \
    ...
    -format   xml \
    -multi_corner yes \
    {C:\GitHub-LSRAM-12.3\RISC-V-Creative-Board-1\Libero_Projects\MiV_AXI_IG2_Creative\designer\BaseDesign\BaseDesign_max_timing_multi_corner.xml} ]
...
set min_timing_violations_multi_corner [report \
    ...
    -format   xml \
    -multi_corner yes \
    {C:\GitHub-LSRAM-12.3\RISC-V-Creative-Board-1\Libero_Projects\MiV_AXI_IG2_Creative\designer\BaseDesign\BaseDesign_min_timing_violations_multi_corner.xml} ]
...
set min_timing_multi_corner [report \
    ...
    -format   xml \
    -multi_corner yes \
    {C:\GitHub-LSRAM-12.3\RISC-V-Creative-Board-1\Libero_Projects\MiV_AXI_IG2_Creative\designer\BaseDesign\BaseDesign_min_timing_multi_corner.xml} ]
